...
it('registers built-in adapters without external discovery', function (): void {
    ...
    expect($registry->all())->toHaveCount(24);
    expect($registry->find('behat'))->toBeInstanceOf(BehatToolAdapter::class);
    expect($registry->find('codeception'))->toBeInstanceOf(CodeceptionToolAdapter::class);
    expect($registry->find('codecept'))->toBeInstanceOf(CodeceptionToolAdapter::class);
    expect($registry->find('phpbench'))->toBeInstanceOf(PhpBenchToolAdapter::class);
    ...
    expect($registry->find('ecs'))->toBeInstanceOf(EasyCodingStandardToolAdapter::class);
    expect($registry->find('easy-coding-standard'))->toBeInstanceOf(EasyCodingStandardToolAdapter::class);
    expect($registry->find('mago'))->toBeInstanceOf(MagoToolAdapter::class);
    expect($registry->find('grumphp'))->toBeInstanceOf(GrumPhpToolAdapter::class);
    ...
    expect($registry->find('composer-normalize'))->toBeInstanceOf(ComposerNormalizeToolAdapter::class);
    expect($registry->find('normalize'))->toBeInstanceOf(ComposerNormalizeToolAdapter::class);
